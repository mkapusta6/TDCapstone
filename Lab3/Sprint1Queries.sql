CREATE TABLE Customer
	...
	EmployeeHandler varchar(40) NOT NULL,	
...
INSERT INTO Auction (AuctionHeading, AuctionDate, R_CustomerName, R_Item, CustomerID, ServiceTicketID) VALUES ('Clothing Auction', '03/03/2021', 'Noah Khan', 'Clothing', '1', '1');
INSERT INTO Auction (AuctionHeading, AuctionDate, R_CustomerName, R_Item, CustomerID, ServiceTicketID) VALUES ('Basketball Auction', '03/08/2021', 'Kobe Bryant', 'Clothing', '2', '1');

Create Table Moving(
	MovingID int IDENTITY(1,1) NOT NULL,
	HouseStories varchar(40) NOT NULL,
	DistanceFromTruck varchar(40) NOT NULL,
	DrivewayAccessibility varchar(40) NOT NULL,
	LoadingConditions varchar(40) NOT NULL,
	HouseSection varchar(40) NOT NULL,
	Mfloor varchar(20) NOT NULL,
