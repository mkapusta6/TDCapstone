<%@ Page Title="" Language="C#" MasterPageFile="~/Activities.Master" AutoEventWireup="true" CodeBehind="AddCustomerPage.aspx.cs" Inherits="Lab3.WebForm1" %>
        ...
        <fieldset style="text-align: left; position: relative; background-color: #FFFF99; top: 0px; left: 0px; height: 404px;">
           ...
           <%-- <asp:Label ID="cusNameLbl" runat="server" Text="Name:" Style="text-align: right"></asp:Label>
            ...
            <asp:RequiredFieldValidator 
                ...
                ControlToValidate="addCustFirstName" 
                runat="server" 
            ...
            <asp:RequiredFieldValidator 
                ID="RequiredLastName" 
                ControlToValidate="addCustLastName" 
                runat="server" 
            ...
            <asp:DropDownList 
                ID="initialContactList" 
                DataTextField="InitialContact" 
                DataValueField="InitialContact"  
                runat="server" 
                style="margin-left: 97px"></asp:DropDownList>
            ...
            <asp:RequiredFieldValidator 
                ...
                ControlToValidate="addCPhone" 
                runat="server" 
                ErrorMessage="Phone Number Required" 
                ForeColor="Red"></asp:RequiredFieldValidator>
            <asp:CompareValidator 
                ID="CompareValidatorPhone" 
                ControlToValidate="addCPhone" 
                runat="server" 
            ...
            <asp:DropDownList 
                ...
                runat="server" 
                style="margin-left: 67px"></asp:DropDownList>
            ...
            <asp:RequiredFieldValidator 
                ID="RequiredFieldValidatorCusEmail" 
                ControlToValidate="addCEmail" 
                runat="server" 
            ...
            <asp:RequiredFieldValidator 
                ID="RequiredFieldValidatorCusStreet" 
                ControlToValidate="addCStreet" 
                runat="server" 
            ...
            <asp:RequiredFieldValidator 
                ID="RequiredFieldValidatorCusCity" 
                ControlToValidate="addCCity" 
                runat="server" 
            ...
            <asp:RequiredFieldValidator 
                ID="RequiredFieldValidatorCusZip" 
                ControlToValidate="AddCZip" 
                runat="server" 
            ...
            <asp:Button ID="addCustBtn" runat="server" Text="Add Customer" OnClick="addCustBtn_Click" Style="margin-top: 29px" />
