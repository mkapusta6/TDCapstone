<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bootsrapNavigationMaster.aspx.cs" Inherits="Lab3.bootsrapNavigationMaster" %>
...
<head runat="server">
   <meta charset="UTF-8">
		<title> Oishii - Fine Japanese Cuisine</title>
...
<polygon class="st0" points="60.1,260.3 167.4,341 180.4,380.3 "/>--%>
		...
		<h1 class="brand brand-name navbar-left"><div class"navbar-left"><img src="images/header-logo.png" /></h1>
        </div>
