...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        ...
        <asp:DropDownList ID="AuctionDropDownList1" runat="server" DataSourceID="dtaScrcAuction" DataTextField="AuctionHeading" DataValueField="AuctionID"></asp:DropDownList>
        <asp:Button ID="Button2" runat="server" Text="Display Auction Info" OnClick="Button2_Click" />
    </fieldset>

    <asp:GridView ID="GridView1" runat="server" EmptyDataText="Does Not Exist"></asp:GridView>
