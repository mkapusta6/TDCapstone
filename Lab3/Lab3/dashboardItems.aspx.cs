    ...
    public partial class WebForm21 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack && reader.HasRows)
            {
                ...
                pushNotificationLabel.Text = "You have new service request(s)";
            }
            else
            {
                reader.Close();
        ...
        protected void searchButton_Click(object sender, EventArgs e)
        {
            ...
            //"WHERE Customer.CustomerName LIKE '%" + searchBox.Text + "%'"; 
        ...
        protected void RequestGrid_RowCommand(Object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Edit")
            {
                ...
                Response.Redirect("bootstrapEditTicketPage.aspx");
            }
